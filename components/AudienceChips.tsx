    ...
    return (
        <div className="space-y-2">
            <div className="flex flex-wrap gap-2 rtl:flex-row-reverse">
                ...
                ${isSelected
                                    ? "bg-[#BAE600] text-[#0A0A0A] scale-105 shadow-[0_0_12px_rgba(201,168,76,0.35)]"
                                    : "border border-white/15 text-white/70 hover:border-[#BAE600]/50 hover:text-white hover:scale-102"
                                }`}
                        >
                            {t(opt.labelKey)}
                        </button>
